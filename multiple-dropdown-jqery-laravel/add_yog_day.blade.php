                  ...
                  @csrf
					...
					<div class="form-group ">
					  ...
					  @if(!empty($workout))
						  ...
						  $week=$workout->week;
						  @endphp
						  <input type="hidden" name="workout_id" value="{{$workout->_id}}" />
                   ...
                   <!-- <div class="form-group ">
					...
					<div id="inputArea" style="margin-left:200px;"><div id="eer"></div> </div>
				  ...
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  ...
					  <div class="modal-footer">
						<button type="button" class="btn btn-secondary" id="added" data-dismiss="modal">Add</button>
...
var countries = [];
   ...
   $("#link_exercise option:selected").each(function () {
	  // alert(253);
     var $this = '<h4>Exercise Name:: </h4>'+'<p>'+$(this).val()+'</p>';
    var newElement2 = '<tr><td></td></tr><tr><td><br/>Sets<input type="number" value="" name="set3_reps[]" placeholder="4.."/></td><td><br/>Rest:<input type="text" value="" name="set3_rest[]" placeholder="Why do you buy this car?"/></td></tr><tr></br></br><td>Tips <textarea placeholder="add tips" name="set3_tips" id="jaddress" class="form-control" cols="2" rows="2"></textarea></td></tr><br/><br/><br/><tr><td><div class="newElement2"></div></td></tr>';
	 
        $("#inputArea").append($this, newElement2);

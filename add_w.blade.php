                ...
                <form class="cmxform form-horizontal " id="signupForm" method="post" action="{!! url('trainer/add_yoga_workout_action') !!}" novalidate="novalidate" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-3">
                       <a href="{!! url('trainer/add_yoga_exercise') !!}">Add Exercises</a>
                      </div>
					  <div class="col-lg-3">
					...
					<div class="exercises">
					  ...
					  @foreach($workout_exercise as $workout_exercises)
					    <div class="row">
							<div class="running">
						<div class="day-run col-lg-3">
						day{{$workout_exercises->day }}
						</div>
					
					
					  <div class="run-exercise col-lg-7">
                        <input class="form-control" id="exercises" value="{{ $workout_exercises->title }}" name="exercises[]" type="text" />
						</div>
						<div class="run-exercise2 col-lg-2">
						 <a href="{!! url('trainer/delete_workout_exercise_yoga',$workout_exercises['_id']) !!}"><button type="button" >x</button></a> 
						</div>
					</div>
						</div>
                      @endforeach
